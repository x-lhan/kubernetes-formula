...
/srv/kubernetes/known_tokens.csv:
  file.managed:
    - source: salt://kubernetes/kube-apiserver/known_tokens.csv
    - template: jinja
    - user: root
    - group: root
    - mode: 600
...
/srv/kubernetes/basic_auth.csv:
  file.managed:
    - source: salt://kubernetes/kube-apiserver/basic_auth.csv
    - template: jinja
    - user: root
    - group: root
    - mode: 600
...
/srv/kubernetes/abac-authz-policy.jsonl:
  file.managed:
    - source: salt://kubernetes/kube-apiserver/abac-authz-policy.jsonl
    - template: jinja
    - user: root
    - group: root
    - mode: 600
...
/etc/kubernetes/manifests/kube-apiserver.manifest:
  file.managed:
    - source: salt://kubernetes/kube-apiserver/kube-apiserver.manifest
    - template: jinja
    - user: root
    - group: root
    - mode: 644
